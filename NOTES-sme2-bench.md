...
| Platform facts | `examples/host_lab.rs`, reports in `host-lab-reports/` | Primitives, core scaling, idle-waiter cost, the SME2 → NEON penalty, the pool by size, two SME2 callers, WFE, measured on the machine it runs on |
